...
func init() {
	...
	flag.IntVar(&Port, "p", 161, "Remote Port: int")
	...
	flag.StringVar(&Portindexfilename, "f", "", "filename with portifindex")
	flag.IntVar(&Debuggmode,"dm",0,"if You wand to debugg, please set it to '1'")
	flag.StringVar(&CallManagerIp, "cm", "", "Call Manager IP")
	flag.IntVar(&LSPflag, "rus", 0, "Get LSP data")

	flag.Parse()
	if Debuggmode == 1{
		fmt.Println("Username: "+UserName)
		fmt.Println("AuthPass: "+AuthPassword)
		fmt.Println("PrivPaaa: "+PrivPassword)
		fmt.Println("AuthType: "+authProtocol)
		fmt.Println("PrivType: "+privProtocol)
		fmt.Println("SnmpVer: "+versionStr)
	}
